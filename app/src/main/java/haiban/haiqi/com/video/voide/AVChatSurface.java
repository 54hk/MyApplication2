...
public class AVChatSurface {
    ...
    public AVChatSurface(Context context
            , View touchLayout
...
//            R.id.touch_zone
        ...
        this.smallSizePreviewFrameLayout = smallSizePreviewFrameLayout;
        this. smallSizePreviewLayout = smallSizePreviewLayout;
        this.  smallSizePreviewCoverImg = smallSizePreviewCoverImg;
        smallSizePreviewFrameLayout.setOnTouchListener(smallPreviewTouchListener);

        this. largeSizePreviewLayout =largeSizePreviewLayout;
        this.  largeSizePreviewCoverLayout = largeSizePreviewCoverLayout;
