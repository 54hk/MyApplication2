...
//        TODO 6666 显示布局
    ...
    public void initLargeSurfaceView(String account) {
        ...
        if (SharePreUtils.getString(HB.NAME , "").equals(account)) {
            ...
            Toast.makeText(App.context,"w我家在的都不就setupLocalVideoRender"+ b , Toast.LENGTH_SHORT).show();
        } else {
            ...
            Toast.makeText(App.context,"w我家在的都不就setupRemoteVideoRender"+ b , Toast.LENGTH_SHORT).show();
        }
